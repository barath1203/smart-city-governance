...
public interface ComplaintRepository extends JpaRepository<Complaint, Long> {
    ...
    List<Complaint> findByStatus(ComplaintStatus status);           // ✅ was String
    List<Complaint> findByDepartment(Department department);        // ✅ was String
